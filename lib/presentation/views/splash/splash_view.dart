...
import 'package:demo_app_lite/config/extensions/app_navigation.dart';
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Future.delayed(const Duration(seconds: 3), () async {
        ...
        String? user = prefs.getString('userDetails');

        if (isLoggedIn && user != null && user.isNotEmpty) {
          final userdata = jsonDecode(user);
          theContext?.navigateReplacedNamed(
            AppRoute.homeRoute,
            arguments: userdata,
          );
        } else {
